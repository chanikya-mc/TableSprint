    ...
    <>
      {isuserexit && (
        <div style={{ display: "flex", height: "100vh" }}>
          ...
          <div><h4><i className="  bi bi-arrow-left-circle h4" onClick={() => { navigate("/category") }}></i> Add to Category</h4>
            <form className="d-flex align-items-center justify-content-between">
              <div className="d-flex align-items-center">
                ...
                <div className="form-group position-relative ms-5">
                  ...
                  <label htmlFor="name" className="custom-label">Category Sequence</label>
                </div>
              </div>
