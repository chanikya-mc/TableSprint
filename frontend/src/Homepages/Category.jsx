            ...
            <div className="container-fluid mt-5">
              ...
              <div className='mt-5'> <table className='table'>
                ...
                <tr itemScope="row">
                  ...
                  <td>Active</td>
                  <td>1</td>
                  <td><button className='btn' onClick={()=>{navigate("/editcategory")}}><i className="bi bi-pencil-square "></i></button> <button className='btn'><i className="bi bi-trash3-fill"></i></button></td>
                </tr>
