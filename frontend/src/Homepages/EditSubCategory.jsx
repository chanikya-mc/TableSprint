    ...
    <>
      {isuserexit && (
        <div style={{ display: "flex", height: "100vh" }}>
          ...
          <div><h4><i className="  bi bi-arrow-left-circle h4" onClick={() => { navigate("/subcategory") }}></i> Edit SubCategory</h4>
            <form className="d-flex align-items-center justify-content-between">
              <div className="d-flex align-items-center">
                ...
                <select name="" id="" style={{width:"150px",height:"40px"}}>
                  <option value=""></option>
                    <option value="Active">tea</option>
                    <option value="inActive">Dal</option>
                  </select>
                  <label htmlFor="name" className="custom-label">Category</label>
                </div>
                <div className="form-group position-relative me-5">
